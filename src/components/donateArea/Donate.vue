<template>
  <div class="donate text-left">
    <div class="title pb-3 mb-3 font-bold text-2xl">
      贊助或請小助手喝杯咖啡？
    </div>
    <p class="text-sm">
      如果小助手幫妳省下很多時間，能否贊助點經費買杯咖啡請我喝喝？有您的捐款小助手將永遠保持免費給粉絲團經營使用。
    </p>
    <br />

    <div class="ecpay">
      <a
        href="https://core.newebpay.com/EPG/comment_helper/AT7UpC"
        target="_blank"
      >
        <img src="https://www.newebpay.com/ud/img/logo_sm2.png" />
      </a>
    </div>
    <p class="text-base mt-4 text-blue-500">非臺灣用戶請使用下方 Paypal 付款</p>
    <form
    ...
    >
      ...
      <table>
        <tr>
          <td style="color: #666">
            <input type="hidden" name="on0" value="Buy Me A Coffee" />Buy Me A
            Coffee
          </td>
        </tr>
        <tr>
          <td>
            ...
            >
              ...
              <option value="Starbucks+Sweets">
                Starbucks+Sweets NT$200 TWD
              </option>
